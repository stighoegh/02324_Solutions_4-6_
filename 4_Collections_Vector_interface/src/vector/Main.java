...
public class Main {
    public static void main(String[] args) {
        IVector[] vectors = new IVector[6]; // kan der sættes I foran den første og den anden
        ...
        vectors[4] = vectors[0].add(vectors[2]);
        vectors[5] = vectors[0].times(4); //Vi er nødt til at caste til vector.Vector
